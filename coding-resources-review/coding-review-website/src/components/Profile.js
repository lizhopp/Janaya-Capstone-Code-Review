...
function Profile() {
  ...
  const handleNavigateToResourceManagement = () => {
    navigate('/resourcemanagement'); // Ensure the path matches the route
  };
  ...
  return (
    <div>
      ...
      <button onClick={handleNavigateToResourceManagement}>Go to Resource Management</button>
    </div>
  );
}
